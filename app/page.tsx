...
export default function HomePage() {
  ...
  const projects = [
    ...
    {
      image: "/dubai-fintech-financial-district.jpg",
      category: "Fintech",
  ...
  return (
    <div className="font-sans text-neutral-800 bg-stone-100 antialiased">
      {/* Navigation */}
      <header
        className={`fixed w-full top-0 z-50 transition-all duration-300 ${isNavbarScrolled ? "bg-slate-800/95 backdrop-blur-md" : "bg-slate-800/80 backdrop-blur-sm"}`}
      >
